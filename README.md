...
`pip install git+https://github.com/biomodels/MODEL1006230059.git`

To install a specific version (in this example, from the 2014-09-16 BioModels release)

`pip install git+https://github.com/biomodels/MODEL1006230059.git@20140916`

## Usage

Importing the model package.

`import MODEL1006230059 as model`
